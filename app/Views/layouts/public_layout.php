...
<head>
    ...
    <title><?= $title ?? 'AMX Cred - Cadastro de Cliente' ?></title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="icon" type="image/x-icon" href="/favicon.ico">
    <meta name="description" content="Cadastre-se na AMX Cred para solicitar seu empréstimo de forma rápida e segura.">
                ...
                <div class="flex items-center">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Empréstimos Rápidos e Seguros</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">AMX Cred</h3>
                    </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-sm text-gray-600">(11) 99999-9999</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            <span class="text-sm text-gray-600">contato@amxcred.com.br</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
