        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg hover:shadow-md transition-shadow duration-200">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-medium text-gray-900">Mensagens do Sistema</h3>
                        <p class="text-sm text-gray-500">Configure textos e mensagens exibidas no sistema</p>
                    </div>
                </div>
                <div class="mt-4">
                    <a href="<?= base_url('/settings/system-messages') ?>" 
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Configure nome, logo, slogan e contatos da empresa</p>
                    </div>
                </div>
                <div class="mt-4">
                    <a href="<?= base_url('/settings/company-info') ?>" 
                       class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-teal-700 bg-teal-100 hover:bg-teal-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-200">
                        Configurar
                        <svg class="ml-2 -mr-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg hover:shadow-md transition-shadow duration-200">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-medium text-gray-900">Configurações de Timezone</h3>
                        <p class="text-sm text-gray-500">Configure o fuso horário do sistema</p>
                    </div>
                </div>
                <div class="mt-4">
                    <a href="<?= base_url('/settings/timezone') ?>" 
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg hover:shadow-md transition-shadow duration-200">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-medium text-gray-900">Área de Testes</h3>
                        <p class="text-sm text-gray-500">Teste funcionalidades de empréstimos e parcelas</p>
                    </div>
                </div>
                <div class="mt-4">
